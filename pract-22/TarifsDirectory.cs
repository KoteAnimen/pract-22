...
namespace pract_22
{
    public partial class TarifsDirectory : Form
    {
        public TarifsDirectory()
        {
            InitializeComponent();
        }

        private void справочникТарифовBindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
            this.Validate();
            this.справочникТарифовBindingSource.EndEdit();
            this.tableAdapterManager.UpdateAll(this.listWorkersDataSet);

        }

        private void TarifsDirectory_Load(object sender, EventArgs e)
        {
